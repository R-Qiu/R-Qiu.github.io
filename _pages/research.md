...
Qiu, Zhuoyu. "[Punching Out, Not Down: The Impact of Paid Sick Leave on Child Maltreatment](https://www.sciencedirect.com/science/article/pii/S0927537126001107?via%3Dihub#tbl1)." *Labour Economics* (2026): 102958. <span style="font-size: 18px;">[<a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5221576" target="_blank" rel="noopener" aria-label="Earlier working-paper version on SSRN (opens in a new tab)">SSRN working paper</a>] [<a href="{{ '/files/Paid_Sick_Leave_Slides.pdf' | relative_url }}" target="_blank" rel="noopener" aria-label="Slides (PDF, opens in a new tab)">slides</a>] [<a href="{{ '/files/Paid_Sick_Leave_Poster.pdf' | relative_url }}" target="_blank" rel="noopener" aria-label="Poster (PDF, opens in a new tab)">poster</a>] [<a href="https://data.mendeley.com/datasets/7tbr28xzky/1" target="_blank" rel="noopener" aria-label="Code and replication materials on Mendeley Data (opens in a new tab)">code</a>]</span>
{: style="margin-bottom: 0.35em;" }

<p style="font-size: 18px; margin-bottom: 0.35em;">Presented at: ACLEC 2025 Poster Session, APPAM 2025, CEA 2025, ISCLE 2025, SEA 2025</p>
...
<p style="font-size: 0.9em;">This paper examines how peer gender composition affects academic progress using administrative records for freshmen entering a selective U.S. public university between 2016 and 2023. I study introductory mathematics courses taken in students’ first quarter, exploiting variation in female peer share across classes of the same course taught by the same instructor in the same term. A 10-percentage-point increase in female peer share raises women’s probability of completing introductory mathematics by 3.0 percentage points and their share of first-quarter courses completed by 2.4 percentage points. Men also experience improvements in first-quarter academic progress, and the baseline estimates provide limited evidence of differences in treatment effects by gender. The findings are robust to controlling for gender composition in other courses and restricting the sample to cohorts whose first-quarter outcomes precede the COVID-19 pandemic. Positive estimates are concentrated among students who declare a STEM major at entry. Longer-term estimates provide suggestive evidence of higher STEM degree attainment among both women and men initially pursuing STEM, although these estimates are less precise. Overall, the findings suggest that female peer exposure supports early academic progress in quantitative coursework, with potential implications for subsequent STEM attainment.</p>
...
<p style="font-size: 0.9em; margin-bottom: 0;">This report examines the Transportation, Distribution, and Logistics (TDL) sector's impact in the Inland Empire (IE), analyzing employment trends, working conditions, and environmental effects on surrounding communities. It calls for policy interventions to strengthen labor standards, arguing that the region's economic growth from TDL should be balanced against worker welfare and community well-being.</p>
</details>
